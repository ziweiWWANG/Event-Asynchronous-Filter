...
### Evaluate HDR dataset reconstruction:
cd eval

run run akf or cf, eval_data = 'tree2_akf'; anal_hdr_results(eval_data);

SSIM MSE PSNR HDRVDP will be saved to `./reconstruction/data_folder` `results.txt` and `results_all.mat`.
