...
% cf_akf_method: 0 run complementary filter (CF) 
%                1 run asynchronous Kalman filter (AKF)
cf_akf_method = 1;
% default cutoff_frequency for complementary filter (CF)
cutoff_frequency_cf = 15;
...
event_asynchronous_filter(cf_akf_method, DataName, deblur_option, ... 
